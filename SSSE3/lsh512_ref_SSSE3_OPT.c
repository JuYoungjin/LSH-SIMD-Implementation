...
#define TwoSTEPs512(j) \
	...
	\
	TT[2] = _mm_shuffle_epi8(TT[6],G2);\
	TT[7] = _mm_shuffle_epi8(TT[7],G3);\
	TT[3] = _mm_shuffle_epi32(TT[7], 78);\
	\
	TT[4] = _mm_shufflehi_epi16(TT[4],147);\
	TT[5] = _mm_shuffle_epi8(TT[5],G1);\
...
void compress512(hashState512 * state, const Byte * datablock) {
	...
	ALIGN(16) const u64 Gamma1[2] = {0x0302010007060504ULL,0x09080f0e0d0c0b0aULL};
	ALIGN(16) const u64 Gamma2[2] = {0x0201000706050403ULL,0x0e0d0c0b0a09080fULL};
	ALIGN(16) const u64 Gamma3[2] = {0x0403020100070605ULL,0x080f0e0d0c0b0a09ULL};
	...
	__m128i G3 = _mm_load_si128((__m128i*)Gamma3);
	__m128i Temp;
	__m128i Temp2;
	__m128i M[16];
	__m128i TT[8];
